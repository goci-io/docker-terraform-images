...
[![](https://images.microbadger.com/badges/image/gocidocker/terraform-k8s-aws.svg)](https://microbadger.com/images/gocidocker/terraform-k8s-aws "Get your own image badge on microbadger.com")
[![](https://images.microbadger.com/badges/version/gocidocker/terraform-k8s-aws.svg)](https://microbadger.com/images/gocidocker/terraform-k8s-aws "Get your own version badge on microbadger.com")
...
docker run \
    ...
    -i gocidocker/terraform-k8s-aws:v1.8 \
    [apply|plan|destroy]
```
...
docker run --entrypoint=/conf/local-start.sh \
    ...
    -v <path_to_modules_dir>:/data \
    -it gocidocker/terraform-k8s-aws:v1.8 \
```
